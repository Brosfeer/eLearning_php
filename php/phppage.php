    ...
    -->
        <div class="row g-4 justify-content-center">
            ...
            <div class="na col-lg-4 col-md-6 wow fadeInUp hoverable"  data-wow-delay="0.1s">
                <form id="contentForm1" method="POST" action="phppage.php">
                    <div class="course-item bg-light">
                        ...
                        <div class="text-center p-4 pb-0">
                            ...
                            <button type="submit" class="btn btn-primary" name="submit" onclick="submitForm('contentForm1')" id="mydiv">Subscription</button><br><br>
